...
var decay_wobble=0.1
export var distort_effect=0.0004
...
func _on_Ball_body_entered(body):
	if body.has_method("hit"):
		...
		$Tween.interpolate_property($Images/Highlight, "scale", Vector2(1.5, 1.5), Vector2(1.0, 1.0), time_highlight_size, Tween.TRANS_BACK, Tween.EASE_IN)
		$Tween.start()
